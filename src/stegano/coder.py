...
def encode_uv_image(U, V, bound):
    ...
    info = "UV|{}|{}|{}|{}|{}|{}|{}|{}x".format(minU, maxU, minV, maxV, bound["top"], bound["bottom"], bound["left"],
                                                   bound["right"])
...
def encode_image(dset, bound):
    ...
    info = "RASTER|{}|{}|{}|{}|{}|{}x".format(minval, maxval, bound["top"], bound["bottom"], bound["left"],
                                                 bound["right"])
    return add_info(img, info)
